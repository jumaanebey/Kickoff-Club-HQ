        ...
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="text-lg h-14 px-8 bg-orange-500 hover:bg-orange-600 text-white shadow-[0_0_40px_rgba(251,146,60,0.3)] rounded-md font-semibold transition-colors">
                <Link href="/auth/sign-up">Start Learning Free</Link>
              </button>
              <button className={cn('text-lg h-14 px-8 border-2 rounded-md font-semibold transition-colors', colors.cardBorder, colors.text, colors.cardHover)}>
