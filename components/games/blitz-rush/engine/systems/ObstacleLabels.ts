// Educational labels for obstacles — maps obstacle types to football positions/terms
import type { ObstacleType } from '../config/constants'
...
export const EDUCATIONAL_LABELS: Record<ObstacleType, ObstacleLabel[]> = {
  defender: [
